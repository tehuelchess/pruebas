...
class CampoPaises extends Campo{
    ...
    protected function display($modo, $dato) {
        ...
        $display.='<select class="select-semi-large paises" data-id="'.$this->id.'" name="' . $this->nombre . '" ' . ($modo == 'visualizacion' ? 'readonly' : '') . '>';
