            ...
            <script>
                $(document).ready(function(){
                    ...
                    function updateRegiones(){
                        $.getJSON("http://api.senatics.gov.py/departamentos?callBack=?",function(data){
                    ...
                    function updateComunas(regionId){
                        ...
                        $.getJSON("http://api.senatics.gov.py/distritos?idDepartamento="+regionId+"&callBack=?",function(data){
