...
class CampoDate extends Campo{
    ...
    protected function display($modo, $dato) {
        ...
        $display.='<input '.($modo=='visualizacion'?'disabled':'').' class="datepicker" ' . ($modo == 'visualizacion' ? 'disabled' : '') . ' type="text" value="' . ($dato && $dato->valor?date('d/m/Y',strtotime($dato->valor)):'') . '" />';
