...
class CampoDate extends Campo{
    ...
    protected function display($modo, $dato) {
        ...
        $display.='<input '.($this->readonly || $modo=='visualizacion'?'disabled':'').' class="datepicker" ' . ($modo == 'visualizacion' ? 'disabled' : '') . ' type="text" value="' . ($dato?date('d/m/Y',strtotime($dato->valor)):'') . '" />';
