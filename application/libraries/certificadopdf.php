...
class CertificadoPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        $this->Image($this->firmador_imagen, PAGE_MARGIN+3*CELL_WIDTH+2*GRID_WIDTH, $y+10, 2*CELL_WIDTH+GRID_WIDTH, 20, '', '', 'T',true);
        ...
        $this->MultiCell(4*CELL_WIDTH+3*GRID_WIDTH, '', 'http://'.(Cuenta::cuentaSegunDominio()?Cuenta::cuentaSegunDominio()->nombre:'localhost').'.chilesinpapeleo.cl/validador o llamando al 101 para teléfonos fijos y celulares.', 0, 'L', false, 1, PAGE_MARGIN);
