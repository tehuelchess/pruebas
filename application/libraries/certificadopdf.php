...
class CertificadoPDF extends TCPDF {
    ...
    public $logo='assets/img/certificados/logo_gobierno-nacional.png';
    ...
    public $firmador_servicio='Gobierno Nacional';
    ...
    public function Footer() {
        ...
        /*$this->Image('assets/img/certificados/color_gobierno-nacional.png', PAGE_MARGIN, $y+70, CELL_WIDTH, 5, '', '', 'T',true);*/
