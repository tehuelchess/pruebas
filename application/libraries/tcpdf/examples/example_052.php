...
$certificate = 'file://../apis.modernizacion.cl.crt';
$certificate_chain = '../gd_bundle.crt';
$private_key = 'file://../apis.modernizacion.cl.key';
...
$pdf->setSignature($certificate, $private_key, '', $certificate_chain, 2, $info);
