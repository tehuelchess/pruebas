<div class="modal-header">
    ...
    <h3 id="myModalLabel">Agregar Dia</h3>
</div>
<div class="modal-body">
        <div class="validacion"></div>
        <label>Por favor, ingrese el detalle del dia <strong><span id="nombredia"></span></strong> </label>
    ...
    function agergar_dia(fe){
        ...
        if(swexiste){
            ...
            if(jQuery.trim(desc)!=''){
                ...
                var url="<?= base_url('backend/agendas/ajax_agregar_dia_feriado') ?>";
                $.ajax({
                    url: url,
                    dataType: "json",
                    data:{
                    ...
                    success: function( data ) {
                        if(data.code==201 || data.code==200){
                            location.href='<?= base_url('backend/configuracion/feriados') ?>';
                        }else{
