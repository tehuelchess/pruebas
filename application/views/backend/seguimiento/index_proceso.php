...
<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu">
        <li><a href="<?=site_url('backend/seguimiento/borrar_proceso/'.$proceso->id)?>" onclick="return confirm('¿Esta seguro que desea eliminar todos los tramites de este proceso?')">Borrar todo</a></li>
    </ul>
</div>
