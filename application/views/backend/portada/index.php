    ...
    <div class="span12">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a href="<?=site_url('backend/portada/widget_create/tramite_etapas')?>">Tramite por etapas</a></li>
                <li><a href="<?=site_url('backend/portada/widget_create/tramites_cantidad')?>">Tramites realizados</a></li>
            </ul>
        </div>
        </p>
    </div>
