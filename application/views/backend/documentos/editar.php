...
<form class="ajaxForm" method="POST" action="<?= site_url('backend/documentos/editar_form/' . ($edit ? $documento->id : '')) ?>">
    <fieldset>
        ...
        <div id="certificadoArea">
            ...
            <textarea name="servicio" class="input-xxlarge" rows="2"><?= $edit ? $documento->servicio : '' ?></textarea>
            <label>URL al sitio web del servicio</label>
            <input class="input-xxlarge" type="text" name="servicio_url" value="<?= $edit ? $documento->servicio_url : '' ?>" placeholder="Ej: http://www.minsegpres.gob.py" />
