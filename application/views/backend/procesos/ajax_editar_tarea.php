        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab3">
                    ...
                    <label class='radio'><input type="radio" name="acceso_modo" value="claveunica" <?= $tarea->acceso_modo == 'claveunica' ? 'checked' : '' ?> /> Sólo los usuarios registrados con Identidad Electrónica.</label>
