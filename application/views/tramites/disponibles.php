<h2>Estos son los trámites que podés solicitar</h2>
        ...
        <?php foreach ($procesos as $p): ?>
            <tr>
                ...
                <td class="actions">
                    ...
                    <?php else: ?>
                        <?php if($p->getTareaInicial()->acceso_modo=='claveunica'):?>
                        <a href="<?=site_url('autenticacion/login_openid')?>?redirect=<?=site_url('tramites/iniciar/'.$p->id)?>"><img style="max-width: none;" src="<?=base_url('assets/img/claveunica-medium_1.png')?>" alt="ClaveUnica" /></a>
                        <?php else:?>
